...
<head>
  ...
  <title>Fashion Guys Staff Portal</title>
  ...
  <style>
    ...
    .header {
      background: linear-gradient(135deg, #C0C0C0 0%,  #005F56 100%);
      backdrop-filter: blur(10px);
      color: white;
      border-radius: 15px;
      margin-bottom: 2rem;
  ...
  <div class="container py-5">
    ...
    <div class="header p-4 mb-5">
      <div class="d-flex align-items-center">
        ...
        <div>
          <h1 class="mb-0">Fashion Guys Staff Portal </h1>
          <p class="mb-0">Select your role to LogIn to the system</p>
        </div>
      </div>
    </div>
