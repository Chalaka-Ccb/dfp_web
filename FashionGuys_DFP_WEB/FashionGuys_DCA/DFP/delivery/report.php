...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        // Title
        $this->Cell(0, 30, 'FashionGuyss - Delivery History', 0, false, 'C', 0, '', 0, false, 'M', 'M');
...
$pdf->SetCreator('FashionGuys Delivery System');
$pdf->SetAuthor('FashionGuys');
$pdf->SetTitle('Delivery History');
$pdf->SetSubject('Delivery Agent History Report');
$pdf->SetKeywords('FashionGuys, PDF, delivery, history, report');
...
$pdf->Cell(0, 10, 'Thank you for being a valued delivery partner with FashionGuys!', 0, 1, 'C', 1);
