...
<head>
   ...
   <title>FashionGuys | Contact</title>
...
<section class="contact-hero py-5" style="background: linear-gradient(135deg, #005F56 0%, #C0C0C0 100%);">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-8 text-center">
        <span class="badge rounded-pill mb-3" style="background-color: rgba(223, 236, 137, 0.1); color:rgb(244, 244, 244); font-size: 2rem;">
           Contact
        </span>
        <h1 class="display-5 fw-bold text-white mb-3">GET IN TOUCH</h1>
        <p class="lead mb-0" style="color: #FFD700;">
          Have questions? We'd love to hear from you. Send us a message and Our team willing to help you at anytime.
          <br><br><br><br>
        </p>
      </div>
    </div>
            ...
            <div class="card border-0 rounded-4 p-4" style="background: white; box-shadow: 0 10px 30px rgba(0,0,0,0.05);">
              <div class="d-flex align-items-center gap-3">
                ...
                <div>
                  ...
                  <p class="mb-0 text-muted">Kaluthara, Sri Lanka</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card border-0 rounded-4 p-4" style="background: white; box-shadow: 0 10px 30px rgba(0,0,0,0.05);">
              <div class="d-flex align-items-center gap-3">
                ...
                <div>
                  ...
                  <p class="mb-0 text-muted">+94 70 668 6955</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card border-0 rounded-4 p-4" style="background: white; box-shadow: 0 10px 30px rgba(0,0,0,0.05);">
              <div class="d-flex align-items-center gap-3">
                ...
                <div>
                  ...
                  <p class="mb-0 text-muted">contact@Fashionguyshr.store</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="row g-4">
                ...
                <div class="col-12">
                  <button type="submit" name="send" class="btn btn-primary px-5 py-3 rounded-pill" 
                          style="background: linear-gradient(45deg, #C0C0C0, #005F56)">
...
<section class="map-section py-5">
  <div class="container">
    <div class="card border-0 rounded-4 overflow-hidden" style="box-shadow: 0 10px 30px rgba(0,0,0,0.05);">
      <iframe 
        src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d1874.2141690029894!2d80.18110144163225!3d6.648648133913518!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e1!3m2!1sen!2slk!4v1749408656840!5m2!1sen!2slk" 
        width="100%" 
        height="400" 
        style="border:0;" 
        allowfullscreen="" 
