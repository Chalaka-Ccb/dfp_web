...
<head>
   ...
   <title>FashionGuys | Shipping Label - Order #<?= $order_id; ?></title>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="d-flex justify-content-between align-items-start mb-4">
                        <div class="company-info">
                            <h3 class="mb-0">FashionGuys</h3>
                            <p class="mb-0">123 Cosmic Way</p>
                            <p class="mb-0">Starfield, ST 12345</p>
                            <p class="mb-0">contact@FashionGuys.lk</p>
                        </div>
                ...
                <div class="card-body p-4">
                    <div class="row mb-4">
                        <div class="col-6">
                            ...
                            <p class="mb-0">123 Cosmic Way</p>
                            <p class="mb-0">Starfield, ST 12345</p>
                            <p class="mb-0">contact@FashionGuys.lk.com</p>
                        </div>
