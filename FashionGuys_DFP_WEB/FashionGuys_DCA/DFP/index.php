...
<section class="home-hero position-relative overflow-hidden" style="background: linear-gradient(135deg, #005F56 0%, #000000 100%);">
  <!-- Animated Background Elements -->
  <div class="position-absolute w-100 h-100" style="top: 0; left: 0; overflow: hidden; opacity: 0.1;">
    <div class="position-absolute" style="width: 300px; height: 300px; border-radius: 50%; background:  #4169E1; top: -100px; left: -100px;"></div>
    <div class="position-absolute" style="width: 200px; height: 200px; border-radius: 50%; background:  #4169E1; bottom: -50px; right: 10%;"></div>
    <div class="position-absolute" style="width: 150px; height: 150px; border-radius: 50%; background:  #4169E1; top: 20%; right: -50px;"></div>
  </div>
  ...
  <div class="container py-5">
    <div class="row align-items-center">
      <div class="col-lg-6 text-white position-relative" style="z-index: 2;">
        ...
        <h1 class="display-4 fw-bold mb-3" style="text-shadow: 0 3px 12px rgba(0,0,0,0.15);">
        Elevate Your <span style="background: linear-gradient(90deg, #580C45, #FFD700); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Style</span> with Exclusive Fashion
        </h1>
        
        <!-- Subtitle with Icon -->
        <p class="mb-4 fs-5">
          <i class="fas fa-tags me-2 text-warning"></i> Timeless fashion, unmatched quality, and exclusive deals
        </p>
        <p class="mb-4">
          Discover the latest trends and curated collections designed for effortless elegance. 
          Shop now before these must-have styles are gone!
        </p>
        ...
        <div class="d-flex flex-wrap gap-4">
          <div class="d-flex align-items-center">
            <i class="fas fa-truck-fast me-2" style="color: #580C45;"></i>
            <span>Free Shipping</span>
          </div>
          <div class="d-flex align-items-center">
            <i class="fas fa-shield-alt me-2" style="color: #580C45;"></i>
            <span>Secure Payment</span>
          </div>
          <div class="d-flex align-items-center">
            <i class="fas fa-undo me-2" style="color: #580C45;"></i>
      ...
      <div class="col-lg-6 position-relative mt-5 mt-lg-0" style="z-index: 1;">
        <!-- Main Product Image with Effects Background Image -->
        <div class="position-relative">
          <img src="dfp.jpeg" class="img-fluid" 
               style="transform: perspective(1000px) rotate3d(0, 1, 0, 15deg); transition: all 0.5s ease;" 
               alt="Methnta logo eka danna ona @manahara"
...
<section class="py-5" style="background: linear-gradient(135deg,  #005F56 0%, #005F56 100%);">
  <div class="container">
    <div class="row g-4 text-center text-white">
      <!-- Feature 1 -->
      <div class="col-6 col-md-3">
        <div class="p-3">
          <i class="fas fa-shipping-fast mb-3" style="font-size: 32px;"></i>
          <h5 class="fw-bold">Free Shipping</h5>
          <p class="mb-0 opacity-75">Enjoy free shipping on orders over 5000</p>
        </div>
      </div>
      ...
      <div class="col-6 col-md-3">
        <div class="p-3">
          <i class="fas fa-exchange-alt mb-3" style="font-size: 32px;"></i>
          <h5 class="fw-bold">Easy Returns</h5>
          <p class="mb-0 opacity-75">15-day return policy for a worry-free shopping experience</p>
        </div>
      </div>
      ...
      <div class="col-6 col-md-3">
        <div class="p-3">
          <i class="fas fa-credit-card mb-3" style="font-size: 32px;"></i>
          <h5 class="fw-bold">Secure Payment</h5>
          <p class="mb-0 opacity-75">Shop confidently with 100% protected payments</p>
        </div>
      </div>
      ...
      <div class="col-6 col-md-3">
        <div class="p-3">
          <i class="fas fa-comments mb-3" style="font-size: 32px;"></i>
          <h5 class="fw-bold">24/7 Support</h5>
          <p class="mb-0 opacity-75">Expert guidance & customer support whenever you need</p>
        </div>
      </div>
    </div>
  </div>
...
<!-- New User Special Offer -->
  ...
  <section class="py-4 py-lg-5"style="background: linear-gradient(135deg,  #C0C0C0 0%, #005F56 100%);">
    <h1 class="display-6 fw-bold" style="color: #580C45; text-align: center;">
      <span class="badge rounded-pill mb-2" style="background-color: #FFD700; color:rgb(0, 0, 0); font-size: 24px;">
        Latest Products
      </span>
    </h1>
    <br>
    <div class="container">
      <div class="row g-3 g-lg-4">
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="card h-100 border-0" style="background:rgb(255, 254, 254); transition: all 0.25s ease-in-out;">
            <div class="position-relative">
