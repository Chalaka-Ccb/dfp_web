...
<head>
   ...
   <title>FashionGuys | Support</title>
...
<section class="support-hero py-5" style="background: linear-gradient(135deg, #005F56 0%,  #C0C0C0 100%);">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-8 text-center">
        <span class="badge rounded-pill mb-3" style="background-color: #000000); color: #FFD700 font-size: 0.9rem;">
          Quick Support
        </span>
        <h1 class="display-5 fw-bold text-white mb-3">HOW CAN WE HELP YOU?</h1>
        <p class="lead mb-0" style="color: #a4b5cf;">
          Submit the your problem. Our team will contact you as soon as possible
        </p>
      </div>
    </div>
  </div>
