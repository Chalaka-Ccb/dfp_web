...
// Change the session ID to check for the Financial Auditor
$auditor_id = $_SESSION['auditor_id'] ?? null; // Use null coalescing for safety

// Redirect to the auditor's login page if not authenticated
if(!isset($auditor_id)){
   header('location:index.php'); // Or the correct path to your auditor login page
   exit();
}
...
if(isset($_GET['delete'])){
   ...
   header('location:financial_auditor_orders.php');
   exit();
}
?>
        ...
        <?php
            if(isset($message) && is_array($message)){
                foreach($message as $msg){
                    echo '<div class="alert alert-info alert-dismissible fade show alert-message" role="alert">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="user-details">
                                <span class="user-name"><?= htmlspecialchars($fetch_orders['name']); ?></span>
                                <span class="user-contact">
                                    <i class="fas fa-phone"></i> <?= htmlspecialchars($fetch_orders['number']); ?>
                                </span>
                                <span class="user-email">
                                    <i class="fas fa-envelope"></i> <?= htmlspecialchars($fetch_orders['email']); ?>
                                </span>
                            </div>
                        </td>
                        <td>
                            <div class="order-details">
                                ...
                                <div class="order-products">
                                    <span class="total-products">
                                        <i class="fas fa-box"></i> Total Products: <?= htmlspecialchars($fetch_orders['total_products']); ?>
                                    </span>
                                    <span class="order-price">
                                        <i class="fas fa-dollar-sign"></i> Total Price: $<?= htmlspecialchars($fetch_orders['total_price']); ?>
                                    </span>
                                </div>
                    ...
                    <button type="submit" name="update_payment" class="btn-update">
                        ...
                        <td>
                            <div class="action-buttons">
                                <a href="financial_auditor_orders.php?delete=<?= $fetch_orders['id']; ?>" 
