...
// Fetch total number of completed orders for revenue
$total_revenue = 0;
...
// Fetch total number of pending transactions
...
$orders_result = $select_orders->fetch(PDO::FETCH_ASSOC);
$total_orders = $orders_result['count'];

// Fetch total number of pending or in-progress staff tasks
$pending_tasks = 0;
$select_pending_tasks = $conn->prepare("SELECT COUNT(*) AS count FROM `staff_tasks` WHERE status = 'pending' OR status = 'in_progress'");
$select_pending_tasks->execute();
$tasks_result = $select_pending_tasks->fetch(PDO::FETCH_ASSOC);
$pending_tasks = $tasks_result['count'] ?? 0;
?>
...
<head>
    ...
    <title>FashionGuys | Financial Auditor Dashboard</title>
                 ...
                 <div class="col-12 col-sm-6 col-xl-3">
                    <div class="stat-card pending-tasks">
                        <div class="card-content">
                            ...
                            <div class="stat-details">
                                <p class="stat-label">Pending Staff Tasks</p>
                                <h3 class="stat-label"><?= number_format($pending_tasks); ?></h3>
                            </div>
                            <a href="auditor_task_management.php" class="stat-link">
                                Manage Staff Tasks
                                <i class="fas fa-arrow-right ms-2"></i>
                            </a>
                        </div>
                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    ...
                    <div class="stat-card total-orders">
                        <div class="card-content">
                            ...
                            <a href="financial_auditor_orders.php" class="stat-link">
                                View All Orders
                                <i class="fas fa-arrow-right ms-2"></i>
                            </a>
                        </div>
