...
class MYPDF extends TCPDF {
    public function Header() {
        ...
        $this->Cell(0, 15, 'FashionGuys.lk - Pending Orders Report', 0, false, 'C', 0, '', 0, false, 'M', 'M');
        $this->Ln(15);
...
if ($pending_value > 10000) {
    ...
    $pdf->MultiCell(0, 10, 'There are ' . count($pending_orders) . ' pending orders with a total value of LKR ' . 
...
$pdf->Cell(95, 10, 'LKR ' . number_format($pending_value, 2), 1, 1, 'R', 0);
...
$pdf->Cell(65, 7, 'Total Value (LKR)', 1, 1, 'C', 1);
...
$pdf->Cell(25, 7, 'Total (LKR)', 1, 0, 'C', 1);
