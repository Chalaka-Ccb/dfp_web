...
<head>
   ...
   <title>FashionGuys | Checkout</title>
...
<section class="checkout-hero py-5" style="background: linear-gradient(135deg,  #C0C0C0 0%, #005F56 100%);">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-8 text-center">
        <span class="badge rounded-pill mb-3" style="background-color: #580C45; color: #FFD700; font-size: 0.9rem;">
          Checkout
        </span>
        <h1 class="display-5 fw-bold text-white mb-3">COMPLETE YOUR ORDER</h1>
        <p class="lead mb-0" style="color: #a4b5cf;">
          Got everything you want? Let's continue
        </p>
      </div>
    </div>
  </div>
      ...
      <div class="card border-0 rounded-4 mb-4" style="background: rgba(255, 255, 255, 0.9); backdrop-filter: blur(10px); box-shadow: 0 10px 30px rgba(0,0,0,0.05);">
        <div class="card-body p-4">
          <div class="d-flex align-items-center gap-3 mb-4">
            ...
            <h4 class="fw-bold mb-0" style="color:  #4169E1;">Order Summary</h4>
          </div>
...
<div class="card border-0 rounded-4" style="background: rgba(255, 255, 255, 0.9); backdrop-filter: blur(10px); box-shadow: 0 10px 30px rgba(0,0,0,0.05);">
        <div class="card-body p-4">
          <div class="d-flex align-items-center gap-3 mb-4">
            ...
            <h4 class="fw-bold mb-0" style="color:  #4169E1;">Shipping Details</h4>
          </div>
            ...
            <div class="col-md-6">
              <div class="form-floating">
                <input type="text" name="name" class="form-control" id="nameInput" placeholder="Your Name" 
                       required maxlength="20" style="border-radius: 12px; border: 1px solid  #C0C0C0;">
            ...
            <div class="col-md-6">
              <div class="form-floating">
                <input type="email" name="email" class="form-control" id="emailInput" placeholder="Your Email" 
                       required maxlength="50" style="border-radius: 12px; border: 1px solid  #C0C0C0;">
            ...
            <div class="col-md-6">
              <div class="form-floating">
                <input type="number" name="number" class="form-control" id="phoneInput" placeholder="Your Phone" 
                       required maxlength="10" style="border-radius: 12px; border: 1px solid  #C0C0C0;">
            ...
            <div class="col-md-6">
              <div class="form-floating">
                <select name="method" class="form-select" id="methodInput" 
                        style="border-radius: 12px; border: 1px solid  #C0C0C0;">
            ...
            <div class="col-md-12">
              <div class="form-floating">
                <input type="number" name="pin_code" class="form-control" id="zipInput" placeholder="ZIP Code" 
                       required maxlength="6" style="border-radius: 12px; border: 1px solid  #C0C0C0;">
