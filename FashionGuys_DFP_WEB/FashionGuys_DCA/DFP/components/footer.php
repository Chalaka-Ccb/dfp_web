<footer class="footer py-5" style="background-color:rgb(0, 0, 0); color: #005F56;">
   <div class="container">
      ...
      <div class="row mb-5">
         <div class="col-lg-4 mb-4 mb-lg-0">
            ...
            <a href="index.php" style="
                ...
                background: linear-gradient(45deg, #005F56 0%, #C0C0C0 100%);
                -webkit-background-clip: text;
                -webkit-text-fill-color: transparent;
            ">
                FashionGuys<span style="color:rgba(183, 173, 0, 0.81);"></span>
            </a>
            </h2>
            <p class="pe-lg-4" style="color: #999999; line-height: 1.8;">
               Discover fashion that fits your style and needs effortlessly. At FashionGuys, we provide premium quality apparel with seamless shopping experiences, tailored just for you.
            </p>
            <div class="d-flex gap-3 mt-4">
               <a href="https://facebook.com" target="_blank" class="btn p-2" style="background-color: rgba(255,255,255,0.1); width: 40px; height: 40px; border-radius: 8px; transition: all 0.3s ease;">
                  <i class="fab fa-facebook-f" style="color: #005F56;"></i>
               </a>
               <a href="https://instagram.com" target="_blank" class="btn p-2" style="background-color: rgba(255,255,255,0.1); width: 40px; height: 40px; border-radius: 8px; transition: all 0.3s ease;">
                  <i class="fab fa-instagram" style="color: #005F56;"></i>
               </a>
               <a href="https://twitter.com" target="_blank" class="btn p-2" style="background-color: rgba(255,255,255,0.1); width: 40px; height: 40px; border-radius: 8px; transition: all 0.3s ease;">
                  <i class="fab fa-twitter" style="color: #005F56;"></i>
               </a>
            </div>
         </div>
            ...
            <div class="d-flex flex-column gap-3">
               <div class="d-flex align-items-center gap-3">
                  <div style="width: 40px; height: 40px; background-color: rgba(255,255,255,0.1); border-radius: 8px; display: flex; align-items: center; justify-content: center;">
                     <i class="fas fa-map-marker-alt" style="color: #005F56;"></i>
                  </div>
                  <div style="color: #999999;">
                     Bulathsinhala,<br>Kaluthara, Sri Lanka
                  </div>
               </div>
               <div class="d-flex align-items-center gap-3">
                  <div style="width: 40px; height: 40px; background-color: rgba(255,255,255,0.1); border-radius: 8px; display: flex; align-items: center; justify-content: center;">
                     <i class="fas fa-phone" style="color: #005F56;"></i>
                  </div>
                  <div style="color: #999999;">
                  <a href="tel:+94706686955" style="text-decoration: none; color: #999999;">+94706686955</a><br><a href="tel:+94 706686955" style="text-decoration: none; color: #999999;">+94 70 668 6955</a>
                  </div>
               </div>
               <div class="d-flex align-items-center gap-3">
                  <div style="width: 40px; height: 40px; background-color: rgba(255,255,255,0.1); border-radius: 8px; display: flex; align-items: center; justify-content: center;">
                     <i class="fas fa-envelope" style="color: #005F56;"></i>
                  </div>
                  <div style="color: #999999;">
                     <a href="mailto:contact@Fashionguyshr.lk" style="text-decoration: none; color: #999999;">contact@Fashionguyshr.lk</a>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="row align-items-center">
         <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
            <p class="mb-0" style="color: #999999;">
               Copyright © <span style="color: #580C45;"><?= date('Y'); ?></span> FashionGuys. All rights reserved.
            </p>
         </div>
