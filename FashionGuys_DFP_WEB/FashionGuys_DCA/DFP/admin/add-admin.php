...
if(isset($_POST['submit'])){
   ...
   if($select_admin->rowCount() > 0){
      ...
      if($pass != $cpass){
         ...
         $message[] = 'New Owner registered successfully!';
      }
   }
}
?>
...
<head>
   ...
   <title>FashionGuys | Add Owner</title>
...
<section class="add-admin mt-5">
    <div class="content-card">
        <div class="card-header">
            ...
            <h2 class="header-title">Add New Owner</h2>
        ...
        <form action="" method="post" class="needs-validation" novalidate>
            ...
            <div class="mb-4">
                <div class="form-floating">
                    ...
                    <label for="name">Owner Username</label>
            ...
            <div class="mb-4">
                <div class="form-floating">
                    <input type="password" 
                           ...
                           maxlength="20"
                           oninput="this.value = this.value.replace(/\s/g, '')">
                    <label for="pass">Owner Password</label>
                    <div class="invalid-feedback">
            ...
            <button type="submit" 
                ...
                <i class="fas fa-user-plus me-2"></i>Register New Owner
            </button>
        </form>
    </div>
</section>
