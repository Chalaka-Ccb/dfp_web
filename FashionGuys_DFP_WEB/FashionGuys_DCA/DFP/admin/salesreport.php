...
class PremiumSalesReportPDF extends TCPDF {
    protected $companyInfo = [
        ...
        'address' => '123 Main Street, Kaluthara, Sri Lanka',
        'phone' => '+94 70 668 6955',
        'email' => 'contact@Fashionguyshr.com',
        'website' => 'www.FashionGuyss.lk'
    ];
...
$pdf->SetCreator('FashionGuyss Admin Panel');
$pdf->SetAuthor('FashionGuyss');
