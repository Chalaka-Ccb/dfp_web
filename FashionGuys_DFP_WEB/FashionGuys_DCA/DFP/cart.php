...
<section class="products shopping-cart py-5" style="background: linear-gradient(135deg, #000000 0%, #005F56 100%);">
   <div class="container">
      <br>
   <div class="text-center mb-5">
      <span class="badge rounded-pill mb-2" style="background-color: rgba(13,110,253,0.1); color: #580C45; font-size: 0.9rem;">
        Cart
      </span>
      <h2 class="fw-bold mb-4" style="color: #FFD700;">Shopping Cart</h2>
    </div>
      ...
      <p class="h5 mt-3"><span class="text-primary">Total Amount: $<?= number_format($grand_total, 2); ?></span><br></p><br>
         <div class="d-flex justify-content-center gap-3 mt-3">
            ...
            <a href="checkout.php" class="btn btn-primary px-4 py-2 <?= ($grand_total > 1) ? '' : 'disabled'; ?>" style="border-radius: 20px;">Go to Checkout</a>
         </div>
      </div>
   </div>
</section>
