...
<head>
   ...
   <title>FashionGuys | Wishlist</title>
...
<section class="products wishlist py-5" style="background: linear-gradient(135deg, #005F56 0%, #C0C0C0 100%);">
   <div class="container">
      <br>
   <div class="text-center mb-5">
      <span class="badge rounded-pill mb-2" style="background: linear-gradient(135deg, #005F56 0%, #000000 100%);">
        FashionGuys / Wishlist
      </span>
      <h2 class="fw-bold mb-4" style="color: #580C45;">Wishlist</h2>
    </div>
   ...
   <div class="table-responsive">
      <table class="table table-hover mb-0" style="min-width: 1000px;">
         <thead style="background-color:  #005F56;">
            <tr>
   ...
   .table th, .table td {
      ...
      <div class="cart-total text-center mt-4">
         ...
         <div class="d-flex justify-content-center gap-3 mt-3">
            ...
            <a href="wishlist.php?delete_all" class="btn btn-outline-danger px-4 py-2 <?= ($grand_total > 1) ? '' : 'disabled'; ?>" onclick="return confirm('Clear Your Wishlist');" style="border-radius: 20px;">Delete All</a>
         </div>
      </div>
   </div>
</section>
